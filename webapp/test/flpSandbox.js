		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#assumeshipment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assumeshipment-display": {
								"semanticObject": "assumeshipment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assumeshipment",
									"url": sap.ui.require.toUrl("assumeshipment")
								}
							}
						}
					}
